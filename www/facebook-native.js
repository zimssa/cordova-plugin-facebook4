...
exports.checkHasCorrectPermissions = function checkHasCorrectPermissions(
  permissions,
  s,
  f
) {
...
exports.getAuthenticationToken = function getAuthenticationToken(s, f) {
  exec(s, f, "FacebookConnectPlugin", "getAuthenticationToken", []);
};
